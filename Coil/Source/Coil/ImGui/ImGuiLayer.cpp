...
namespace Coil
{
	...
	bool ImGuiLayer::OnKeyPressedEvent(KeyPressedEvent& event)
	{
		...
		io.KeyCtrl = io.KeysDown[CL_KEY_LEFT_CONTROL] || io.KeysDown[CL_KEY_RIGHT_CONTROL];
		io.KeyAlt = io.KeysDown[CL_KEY_LEFT_ALT] || io.KeysDown[CL_KEY_RIGHT_ALT];
		io.KeyShift = io.KeysDown[CL_KEY_LEFT_SHIFT] || io.KeysDown[CL_KEY_RIGHT_SHIFT];
		io.KeyCtrl = io.KeysDown[CL_KEY_LEFT_SUPER] || io.KeysDown[CL_KEY_RIGHT_SUPER];
		return false;
	}
