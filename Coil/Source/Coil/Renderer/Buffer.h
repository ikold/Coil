...
namespace Coil
{
	...
	public:
		...
		const std::vector<BufferElement>::const_iterator begin() const { return Elements.begin(); }
		const std::vector<BufferElement>::const_iterator end() const { return Elements.end(); }
